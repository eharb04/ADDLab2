...
package scopeToHdmi_package is
    ...
    constant VIDEO_HEIGHT_IN_BITS: NATURAL := 10;       -- 750 "pixels" tall, includes FP, SYNC, and BP
    ...
    constant R_EDGE     : STD_LOGIC_VECTOR(VIDEO_WIDTH_IN_BITS-1 downto 0) := std_logic_vector(to_unsigned(1100,VIDEO_WIDTH_IN_BITS));
    constant WIDTH      : STD_LOGIC_VECTOR(VIDEO_WIDTH_IN_BITS-1 downto 0) := R_EDGE - L_EDGE;

    constant T_EDGE     : STD_LOGIC_VECTOR(VIDEO_HEIGHT_IN_BITS-1 downto 0) := std_logic_vector(to_unsigned(100,VIDEO_HEIGHT_IN_BITS));
    constant B_EDGE     : STD_LOGIC_VECTOR(VIDEO_HEIGHT_IN_BITS-1 downto 0) := std_logic_vector(to_unsigned(700,VIDEO_HEIGHT_IN_BITS));
    constant HEIGHT     : STD_LOGIC_VECTOR(VIDEO_HEIGHT_IN_BITS-1 downto 0) := B_EDGE - T_EDGE;
	
    -- This is actually half of the width
    constant BORDER_LINE_WIDTH  : NATURAL := 3;
    ...
    -- BLUE
    constant GRID_R : STD_LOGIC_VECTOR(7 downto 0) := X"00";
    constant GRID_G : STD_LOGIC_VECTOR(7 downto 0) := X"00";
    ...
    constant TRIGGER_B  : STD_LOGIC_VECTOR(7 downto 0 ) := X"00";
